    ...
    <AnimatePresence>
      {boost && (
        ...
        >
          ...
          <div className="absolute right-4 top-3 flex items-center gap-1.5 rounded-full bg-dark px-3 py-1 font-mono text-[10px] uppercase tracking-[0.18em] text-on-dark shadow-lg">
